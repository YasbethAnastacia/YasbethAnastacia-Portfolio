      ...
      <div className="mt-8 animate-[experienceBlock_550ms_ease-out_both] transition-colors duration-500">
        ...
        <ul className="flex flex-col gap-3">
          {experiencia.responsabilidades.map((item, index) => (
            <li
              key={item}
              className="site-stagger-item group flex gap-3 text-[var(--text-secondary)] leading-relaxed transition-all duration-300 hover:translate-x-1 hover:text-[var(--text-primary)]"
              style={{
            ...
            {experiencia.tecnologias.map((tecnologia, index) => {
              ...
              return (
                <div
                  ...
                  className="group flex items-center gap-2 px-3.5 py-2 rounded-xl bg-[var(--background-soft)] border border-[var(--border-color)] text-sm text-[var(--text-secondary)] transition-all duration-300 ease-out hover:-translate-y-1 hover:bg-[var(--primary-10)] hover:border-[var(--primary-color)] hover:text-[var(--text-primary)] hover:shadow-md"
                >
                  <TecnologiaIcono
                    size={15}
