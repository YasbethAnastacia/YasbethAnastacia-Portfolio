    ...
    return (
        <ol className="relative ml-3">
            ...
            {items.map((experiencia, index) => {
                ...
                const activaMovil =
                    activaActual && mostrarDetalleMovil;
                ...
                return (
                    <li
                        ...
                        className="
                            relative
                            animate-[timelineItem_500ms_ease-out_both]
                        "
                        style={{
                    ...
                    >
                        <button
                            ...
                            className={`
                                ...
                                ${
                                    activaActual
                                        ? "lg:bg-[var(--primary-10)]"
                                        : "lg:hover:bg-[var(--background-soft)]"
                                }
                                    ...
                                    ${
                                        activaMovil
                                            ? `
                                                ...
                                                shadow-[0_0_16px_var(--primary-soft)]
                                                scale-125
                                            `
                                            : `
                                                w-3
                                    ...
                                    ${
                                        activaActual
                                            ? `
                                                ...
                                                lg:border-[var(--background-card)]
                                                lg:shadow-[0_0_16px_var(--primary-soft)]
                                                lg:scale-125
                                            `
                                            : ""
                                    }
                                ...
                                <div className="min-w-0">
                                    <p
                                        className={`
                                            ...
                                            ${
                                                activaActual
                                                    ? "lg:text-[var(--primary-color)] lg:text-lg"
                                                    : ""
                                            }
