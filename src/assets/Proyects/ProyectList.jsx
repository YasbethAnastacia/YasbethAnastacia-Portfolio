        ...
        <div className="px-3 flex gap-3 items-start">
            ...
            <div className="flex flex-col">
                ...
                <div className="flex">
                    ...
                    <div className="bg-white w-[11px] h-[11px] rounded-full mt-2 shrink-0" />

                    <button className="shadow-lg rounded-xl p-3 flex gap-3 w-full hover:scale-105 transition-transform duration-300 select-none">
