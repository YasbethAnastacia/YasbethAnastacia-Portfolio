...
export const Hero = () => {
  ...
  return (
    <section id="inicio" className="relative grid grid-cols-1 lg:grid-cols-[1.5fr_1fr] items-center overflow-hidden px-5 md:px-10 lg:px-18 py-10 bg-[var(--background)] transition-colors duration-500">
      <div className="flex flex-col gap-8 relative z-10 animate-[heroLeft_800ms_cubic-bezier(0.22,1,0.36,1)_both]">
        ...
        <div className="flex flex-col gap-2">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-[var(--text-accent)] animate-[heroText_700ms_cubic-bezier(0.22,1,0.36,1)_both]" style={{ animationDelay: "220ms" }}>
            {t.role}
          </h2>
        </div>
        ...
        <div className="bg-[var(--background-card)] border border-[var(--border-color)] rounded-2xl shadow-lg py-3 w-full max-w-[400px] overflow-hidden transition-all duration-500 animate-[heroText_700ms_cubic-bezier(0.22,1,0.36,1)_both]" style={{ animationDelay: "420ms" }}>
          <div ref={trackRef} className="flex gap-5 w-max will-change-transform" aria-label={language === "es" ? "Tecnologías" : "Technologies"}>
            {tecnologiasDuplicadas.map((tecnologia, index) => <div key={`${tecnologia.id}-${index}`} aria-hidden={index >= tecnologias.length} className="group flex items-center justify-center w-[60px] h-[60px] rounded-xl bg-[var(--background-soft)] border border-[var(--border-color)] shrink-0 transition-all duration-300 hover:-translate-y-1 hover:shadow-md">
        ...
        <div className="flex flex-wrap gap-4 md:gap-6 animate-[heroText_700ms_cubic-bezier(0.22,1,0.36,1)_both]" style={{ animationDelay: "520ms" }}>
          ...
          <button type="button" onClick={() => irASeccion("contacto")} className="group flex items-center gap-2 px-8 py-4 rounded-xl border-2 border-[var(--primary-color)] text-[var(--text-accent)] bg-transparent font-semibold transition-all duration-300 hover:bg-[var(--primary-10)] hover:-translate-y-1 hover:shadow-lg active:translate-y-0">
            {t.contact}
      ...
      <div className="relative flex justify-center items-center h-[580px] md:h-[650px] lg:h-[700px] animate-[heroRight_900ms_cubic-bezier(0.22,1,0.36,1)_both]">
        ...
        <div className="group relative z-10 w-[370px] max-w-full h-[470px] md:w-[470px] md:h-[590px] overflow-hidden rounded-[45%_55%_48%_52%/55%_45%_55%_45%] shadow-2xl ">
          <img className="w-full h-full object-cover object-top transition-transform duration-700 ease-out group-hover:scale-[1.03]" src="/HERO/hero-portada.png" alt="Yasbeth Anastacia Vázquez Hernández" fetchPriority="high" draggable={false} />
        </div>
